...
const png=fs.readFileSync('source-art/yukina-run.png');let w,h,depth,type,packed=[];
...
const scope={document:{}};vm.createContext(scope);vm.runInContext(fs.readFileSync('docs/sprite-renderer.js','utf8'),scope);scope.prepareYukinaPixels(rgba,true);
